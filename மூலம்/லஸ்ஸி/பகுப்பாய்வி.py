...
from ._வெளியே.lark import Lark as லார்க, Transformer as மாற்றி, Tree, Token
...
class நிரல்மொழிப்பாகுப்படுத்தி(object):
    ...
    def வரிசைமாற்றி_பெறு(தன், மூல்மொழி, வேண்டியமொழி, பதிப்பு=None):
        ...
        def வரிசை_பெறு(மூல், வேண்டியது):
            ...
            வரி = []
            for உருப்படி in மூல்_உருப்படிகள்:
        ...
        for விதி in விதிகள்:
            ...
            மூல்_விதி = நிரல்மொழிகள்.விதி_மொழிபெயர்ப்பு(தன்.நிரல்மொழி, மொழி=மூல்மொழி, விதி=விதி)
            வேண்டிய_விதி = நிரல்மொழிகள்.விதி_மொழிபெயர்ப்பு(தன்.நிரல்மொழி, மொழி=வேண்டியமொழி, விதி=விதி)
...
def வரிசைமாற்றி_பெறு(நிரல்மொழி, மூல்மொழி, வேண்டியமொழி, பதிப்பு=None) -> Optional[மாற்றி]:
